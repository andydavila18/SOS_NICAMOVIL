...
public class ws_carro {

    final static String Controlador = "/Carro/";

    // Get : Permite obtener datos de un Carro por un usuario
    ...
    // Post : Permite insertar datos de un carro
    ...
    // Post : Permite insertar datos de un carro
    public static JsonObjectRequest Delete(String Usuario, final E_API.VolleyResponseListener Listener) {
        JsonObjectRequest Peticion= new JsonObjectRequest
                (Request.Method.DELETE,E_API.URL+Controlador+Usuario, (String) null, new Response.Listener<JSONObject>() {
                    @Override
                    public void onResponse(JSONObject Respuesta) {
                        try {
                            Listener.onResponse(Respuesta);
